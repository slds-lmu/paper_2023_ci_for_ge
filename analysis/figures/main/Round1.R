...
Widths <- Widths[loss %in% translate_losses("Squared", "Zero-One") &
                   as.character(dgp) %nin% susDGPs,
                 list(
...
# save this in figures/main instead of Aggr_Plots
ggsave(here("figures", "main", "FirstRound_different_stand.png"), width = 11.5, height = 9)
