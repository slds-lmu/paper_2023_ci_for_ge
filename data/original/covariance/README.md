These are real-world datasets from which covariance matrices are estimated, that are then used to simulate data from a multivariate normal distribution.
