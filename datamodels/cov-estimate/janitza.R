...
write_parquet(colon, here("data", "cov-estimate", "colon.parquet"))
rm(colon)
...
write_parquet(breast, here("data", "cov-estimate", "breast.parquet"))
rm(breast)
...
write_parquet(prostate, here("data", "cov-estimate", "prostate.parquet"))
rm(prostate)
