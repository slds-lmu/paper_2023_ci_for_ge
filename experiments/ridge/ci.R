...
EXPERIMENT_PATH = Sys.getenv("RESAMPLE_PATH_RIDGE")
EVAL_PATH = Sys.getenv("CI_PATH_RIDGE")

EVAL_REG = makeRegistry(EVAL_PATH,
  packages = c("inferGE", "mlr3misc", "mlr3", "digest", "withr", "uuid", "batchtools", "tictoc", "duckdb", "mlr3pipelines", "mlr3learners", "ranger", "mlr3oml", "data.table", "here"),
  seed = 1L,
)
